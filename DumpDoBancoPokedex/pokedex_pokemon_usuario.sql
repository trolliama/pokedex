...
DROP TABLE IF EXISTS `pokemon_usuario`;
...
CREATE TABLE `pokemon_usuario` (
  ...
  KEY `cpf_idx` (`cpf`),
  CONSTRAINT `id` FOREIGN KEY (`id_pokemon`) REFERENCES `pokemon` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
LOCK TABLES `pokemon_usuario` WRITE;
/*!40000 ALTER TABLE `pokemon_usuario` DISABLE KEYS */;
/*!40000 ALTER TABLE `pokemon_usuario` ENABLE KEYS */;
UNLOCK TABLES;
