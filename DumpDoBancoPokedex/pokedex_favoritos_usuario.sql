...
CREATE TABLE `favoritos_usuario` (
  ...
  CONSTRAINT `favoritos_usuario_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`),
...
INSERT INTO `favoritos_usuario` VALUES (2,1,1),(3,2,1),(5,15,1),(6,14,1),(7,10,1);
